<div id="kt_header" class="header align-items-stretch">
    ...
    <div class="toolbar d-flex align-items-stretch">
        ...
        <div class="py-6 container-xxl py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
            <!--begin::Page title-->
            ...
            <div class="pt-3 overflow-auto d-flex align-items-stretch pt-lg-0">
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Label-->
                    <span class="text-gray-700 fs-7 fw-bold pe-4 text-nowrap d-none d-xxl-block">Sort By:</span>
                    <!--end::Label-->
                    <!--begin::Select-->
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Separartor-->
                    <div class="mx-5 bullet bg-secondary h-35px w-1px"></div>
                    <!--end::Separartor-->
                    <!--begin::Label-->
                    <span class="text-gray-700 fs-7 fw-bold d-none d-sm-block">Impact
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Label-->
                    <span class="text-gray-700 fs-7 fw-bold pe-3 d-none d-xxl-block">Quick Tools:</span>
                    <!--end::Label-->
                    <!--begin::Actions-->
                    <div class="d-flex">
                        <!--begin::Action-->
